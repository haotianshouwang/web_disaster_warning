...
class WebAdminServer:
    ...
    def __init__(self, disaster_service, config: dict[str, Any]):
        # WebAdminServer 现在主要承担宿主/装配入口职责，
        ...
        # 延迟缓存由健康监控器写入，再由 connections / realtime payload 构建器复用。
    ...
    def _setup_app(self):
        ...
        # 鉴权配置先于路由注册完成，确保 middleware / websocket 能复用同一套运行时状态。
    ...
    async def start(self):
        ...
        # server/广播/ping 三类任务分开维护，便于停机时按职责逐项回收。
