    ...
    async def start(self) -> None:
        ...
        async with self.service._start_lock:
            ...
            try:
                ...
                self.service.cache_service.load_earthquake_lists_cache()
                self.service.cache_service.load_eew_query_cache()
    ...
    async def stop(self) -> None:
        ...
        async with self.service._stop_lock:
            ...
            try:
                ...
                if was_running:
                    self.service.cache_service.save_earthquake_lists_cache()
                    self.service.cache_service.save_eew_query_cache()
